...
const Profile = () => {
    return ( 
        <div className=' mt-40 text-white font-mono text-center' id="profile">
            <h1 className="text-3xl mb-5">A quick introduction</h1>
        <div className="flex justify-center flex-col sm:flex-row items-center">
            <div className="m-1 h-52 w-10/12 flex flex-col text-white rounded-xl items-center shadow-2xl mb-5 sm:w-4/12">
                <div className="mt-5">
