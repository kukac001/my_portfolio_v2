...
const MainGrid = () => {
    return ( 
        <div className="w-11/12  bg-opacity-10 flex rounded-3xl border-opacity-30 border-r-0 border-b-0 backdrop-filter backdrop-blur-md font-mono text-white mt-5 text-2xl m-auto">
